...
Source Server         : 192.168.234.136--slave02
Source Server Version : 50740
Source Host           : 192.168.234.136:3306
Source Database       : testdb02

Target Server Type    : MYSQL
Target Server Version : 50740
File Encoding         : 65001

Date: 2025-01-24 14:22:03
*/
...
CREATE TABLE `kpi_info_0` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1089542520154619913 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `kpi_info_1` (
  ...
  `value` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1089542520154619909 DEFAULT CHARSET=utf8mb4;
